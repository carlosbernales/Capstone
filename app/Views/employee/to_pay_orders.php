                  ...
                  <th>Action</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                          ...
                          <td>
                          <form id="toPayOrders" action="<?= base_url('employee_orders_update_' . $orders['id']) ?>" method="post">
                          <input type="hidden" name="order_status" value="To Deliver">
                          <input type="hidden" value="<?= $orders['user_email'] ?>" name="user_email">
                          <input type="hidden" value="<?= $orders['order_id'] ?>" name="order_id">
                          <input type="hidden" value="<?= $orders['order_amount'] ?>" name="order_amount">
                          <input type="hidden" value="<?= $orders['order_type'] ?>" name="order_type">

                          <input type="hidden" value="<?= $orders['firstname'] ?>" name="firstname">
                          <input type="hidden" value="<?= $orders['lastname'] ?>" name="firstname">
                          <input type="hidden" value="<?= $orders['shipping_fee'] ?>" name="shipping_fee">
                          <input type="hidden" value="<?= $orders['selected_barangay'] ?>" name="selected_brgy">
                          <input type="hidden" value="<?= $orders['selected_city'] ?>" name="selected_city">
                          <input type="hidden" value="<?= $orders['other_infoaddres'] ?>" name="other_infoaddres">
                          <input type="hidden" value="<?= $orders['contact'] ?>" name="contact">
                          <button class="btn btn-primary fw-bold" type="submit">To Ship</button>
                      </form>
                          </td>
                      </tr>
                      <?php endforeach; ?>
...
function showSweetAlert() {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        document.getElementById('toPayOrders').submit();
      }
    });
  }
  document.getElementById('toPayOrders').addEventListener('submit', function(event) {
