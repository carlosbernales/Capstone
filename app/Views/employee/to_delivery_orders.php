                        ...
                        <th>Action</th>
                          ...
                          <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                <form id="deliveredOrders"  action="<?= base_url('employee_orders_update_' . $orders['id']) ?>" method="post">
                                ...
                                <button class="btn btn-success fw-bold" type="submit">Delivered</button>
                                </form>
                                </td>
                            </tr>
                            <?php endforeach; ?>
  ...
  function showSweetAlert() {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        document.getElementById('deliveredOrders').submit();
      }
    });
  }
  document.getElementById('deliveredOrders').addEventListener('submit', function(event) {
