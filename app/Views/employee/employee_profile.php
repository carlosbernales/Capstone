              ...
              <div class="profile-info">
                <div class="profile-field">
                  ...
                  <span class="field-value">
                    ...
                    <a style="color: white; cursor: pointer;" data-toggle="modal" data-target="#fullnameModal">
                ...
                <div class="profile-field">
                  ...
                  <span class="field-value">
                    ...
                    <a style="color: white; cursor: pointer;" data-toggle="modal" data-target="#emailModal">
                       <span class="fa fa-edit" style="font-size: 18px; font-weight: bold; color: red; cursor: pointer;"></span>
                    </a>
                  </span>
                </div><br>
                ...
                <div class="profile-field">
                  ...
                  <span class="field-value">
                    ...
                    <a style="color: white; cursor: pointer;" data-toggle="modal" data-target="#contactModal">
                      <span class="fa fa-edit" style="font-size: 18px; font-weight: bold; color: red; cursor: pointer;"></span>
                    </a>
                  </span>
                </div><br>
                ...
                <div class="profile-field">
                  ...
                  <span class="field-value">
                    ...
                    <a style="color: white; cursor: pointer;" data-toggle="modal" data-target="#addressModal">
                       <span class="fa fa-edit" style="font-size: 18px; font-weight: bold; color: red; cursor: pointer;"></span>
                    </a>
                  </span>
                </div><br>
                ...
                <div class="profile-field">
                  ...
                  <span class="field-value">
                    <a style="color: white; cursor: pointer;" data-toggle="modal" data-target="#passwordModal">
                       <span class="fa fa-edit" style="font-size: 18px; font-weight: bold; color: red; cursor: pointer;"></span>
                    </a>
                  </span>
                </div>
                    ...
                    <div class="modal fade" id="emailModal" tabindex="-1" role="dialog" aria-labelledby="emailModalLabel" aria-hidden="true" data-backdrop="false">
                      <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                          ...
                          <form action="<?= site_url('saveMyaccount') ?>" method="POST" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                            <div class="row">
                              <div class="col-md-12">
