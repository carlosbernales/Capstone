                  ...
                  <tbody>
                    <?php foreach($employee as $account) : ?>
                      <tr>
                        ...
                        <td>
                          <form method="post" action="<?=base_url('update_employee_'.$account['id'])?>">
                          <input type="hidden" name="email" value="<?php echo $account['email']; ?>" class="form-control">
                          <input type="hidden" name="firstname" value="<?php echo $account['firstname']; ?>" class="form-control">
                          <input type="hidden" name="lastname" value="<?php echo $account['lastname']; ?>" class="form-control">
                          <input type="hidden" name="phone" value="<?php echo $account['phone']; ?>" class="form-control">
                          <input type="hidden" name="address" value="<?php echo $account['address']; ?>" class="form-control">
                            <?php if ($account['status'] !== 'verified') : ?>
                              <button class="btn btn-info text-white btn-sm" name="status" value="verified">Approve</button>
                            <?php endif; ?>

                            <?php if ($account['status'] !== 'not_verified') : ?>
                              <button class="btn btn-danger text-white btn-sm" name="status" value="not_verified">Decline</button>
                            <?php endif; ?>
