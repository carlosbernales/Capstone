    ...
    <div class="dropdown-menu dropdown-list dropdown-menu-right pullDown">
        ...
        <?php endif; ?>
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown"
              class="nav-link dropdown-toggle nav-link-lg nav-link-user"> <img alt="image" src="<?= base_url('public/assets/img/user.pn') ?>g"
      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <a href="#" class="btn btn-success" data-toggle="modal" data-target="#addProductMOdal" style="margin-right: 10px;">+ Add Category</a>
          </div>
            <div class="card-body">
                    ...
                    <?php foreach ($category as $row) : ?>
                      <tr>
                        ...
                        <td style="width:12%">
                          ...
                          <a href="<?= site_url('delete_category'.$row['id']) ?>" class="btn btn-danger btn-sm delete" onclick="confirmDelete(event)">Delete</a>
                        </td>
                      </tr>
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="editModalLabel-<?php echo $row['id']; ?>">Edit Product Category</h5>
                              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                              </button>
                            </div>
                            <div class="modal-body">
                              <form id="editCategoryForm-<?php echo $row['id']; ?>" action="<?= site_url('category_update_' . $row['id']) ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                  <div class="col-md-12">
                                    <div class="form-group mb-2">
                                      ...
                                      <input type="text" class="form-control" id="name" name="category_name" value="<?php echo $row['cat_name']; ?>" required>
                                    </div>
                                  </div>
                                  <div class="col-md-12">
                                    <hr>
...
<div class="modal fade" id="addProductMOdal" tabindex="-1" role="dialog" aria-labelledby="addProductMOdalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form id="addcategoryform" action="<?= site_url('addcategory') ?>" method="POST" enctype="multipart/form-data">
        <?=csrf_field();?>
          <div class="row">
            <div class="col-md-12">
              <div class="form-group mb-2">
  ...
  //FOR SUBMITTING UPDATE CATEGORY FORM
   $(document).ready(function() {
        $('button[data-toggle="modal"]').click(function() {
            ...
            $(targetModalId).find('form').attr('action', 'category_update_' + categoryId); // Update form action URL
        });
    });
