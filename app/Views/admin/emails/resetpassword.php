...
<body style="margin: 0; padding: 0;">
    <div style="width: 600px; margin: auto; overflow: hidden; border: 1px solid #E5E5E5; background-repeat: no-repeat; background-position: 0px 91px;">
        ...
        <div style="background-color: #EEFDEB; margin-top: 10px; padding: 10px; text-align: center;">
                ...
                <table width="100%" style="border-radius: 5px; border: 1px solid #000; padding: 13px 25px;">
                    <tr>
                        ...
                        <td style="text-align: right;">
                            <table width="100%;">
                                <tr>
                                    <td style="text-align: center;"><a href="https://www.facebook.com/profile.php?id=100088678795529" style="line-height: 0; display: block;"><img src="https://i.postimg.cc/HnPDpXZQ/xxx.png"></a></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
