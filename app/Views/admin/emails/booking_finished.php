...
<tr>
    <td style="background: #fff; font-size: 25px; padding: 0 26px;">
        ...
        <p style="text-align: justify;">
            Hello! Your booking has been successfully completed. We trust that we've met your service expectations. Thank you, and may you enjoy a wonderful day ahead!
        </p>
    </td>
</tr>
        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color: #EEFDEB; margin-top: 10px;">
            <thead style="background-color: #EEFDEB;">
                <tr>
                    ...
                    <td style="width: 20%; padding: 10px; font-weight: 400; font-size: 20px; text-align: center;">Time Started</td>
                </tr>
            </thead>
