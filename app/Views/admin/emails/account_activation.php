...
<tr>
    <td style="background: #fff; font-size: 25px; padding: 0 26px;">
        ...
        <p style="text-align: justify;">
            Welcome to Bituins Flower Shop. To continue, please confirm your account by clicking this <a href="<?php echo base_url(); ?>/verify/<?php echo $token; ?>">Activate Account</a>
        </p>
    </td>
</tr>
