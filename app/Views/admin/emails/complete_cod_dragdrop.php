...
<tr>
    <td style="background: #fff; font-size: 25px; padding: 0 26px;">
        ...
        <p style="text-align: justify;">
            Your Cash on Delivery (COD) for customize order <span style="color: red;"><?= $order_id ?></span> has been delivered successfully.
            We are thankful and grateful to have you as our customer.
        </p>
    </td>
</tr>
...
<tr>
    <td style="padding: 26px 26px 0px;">
        ...
        <tfoot>
            ...
            <tr>
                <td colspan="2" style="text-align: right; width: 20%; font-weight: 400; font-size: 19;">Shipping Fee:</td>
