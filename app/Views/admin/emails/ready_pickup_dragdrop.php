...
<tr>
    <td style="background: #fff; font-size: 25px; padding: 0 26px;">
        ...
        <p style="text-align: justify;">
             Your pick up order <span style="color: red;"><?= $order_id ?></span> is ready. We kindly request your presence at our shop to pick up your order.
             To ensure a smooth transaction, we kindly ask that you come prepared with the exact payment amount. Thank you !
        </p>
    </td>
</tr>
...
<tr>
    <td style="padding: 26px 26px 0px;">
        ...
        <tfoot>
            <tr>
                <td colspan="2" style="text-align: right; width: 20%; font-weight: 400; font-size: 19;">Total:</td>
