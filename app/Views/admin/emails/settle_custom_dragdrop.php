...
<tr>
    <td style="background: #fff; font-size: 25px; padding: 0 26px;">
        ...
        <p style="text-align: justify;">
            Your customize order <span style="color: red;"><?= $order_id ?></span> price has been released by our shop.
            Please review your order and click "Agree" if you agree with the price and proceed to "Place Order." Click "Decline" if not. Thank you!
        </p>
    </td>
</tr>
    ...
    <td style="padding: 26px 26px 0px;">
        <table width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color: #EEFDEB; margin-top: 10px;">
            <thead style="background-color: #EEFDEB;">
                <tr>
                    <td style="width: 20%; padding: 10px; font-weight: 400; font-size: 20px; text-align: center;">Product Name</td>
                    <td style="width: 20%; padding: 10px; font-weight: 400; font-size: 20px; text-align: center;">Color</td>
        ...
        <tbody>
            <?php for ($i = 0; $i < count($item_names); $i++) { ?>
                <tr>
                    ...
                    <td style="text-align: center; font-size: 18px;"><?= $item_colors[$i] ?></td>
        ...
        <tfoot>
            <tr>
                <td colspan="2" style="text-align: right; width: 20%; font-weight: 400; font-size: 19;">Subtotal:</td>
            ...
            <td style="padding: 26px; background-image: url(https://i.postimg.cc/RZfQd50z/1-Transactional-xxx-Order-xxx-svg-1.png); background-repeat: no-repeat; background-position: 100% 350px; width: 100%;">
                <table width="100%;">
                    ...
                    <tr>
                        <td>
                            <div>
                                <p style="font-weight: 600; margin: 0; font-size: 16px;">Pick up to:</p>
                                <p style="margin: 0; font-size: 20px; font-size: 15px;">Jenny B. Acedillo</p>
                                <p style="margin: 0; font-size: 20px; font-size: 15px;">Calapan City</p>
                                <p style="margin: 0; font-size: 20px; font-size: 15px;">Bonifacio Street, Brgy. Ilaya</p>
                                <p style="margin: 0; font-size: 20px; font-size: 15px;">Tel. 09951776920</p>
                            </div>
                        </td>
                    </tr>
                    <tr>
