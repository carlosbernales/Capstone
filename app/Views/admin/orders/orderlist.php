      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              <a href="<?= base_url('productlist') ?>" class="nav-link"><i data-feather="codepen"></i><span>Products</span></a>
            </li>
                  ...
                  <tbody>
                    <?php foreach($orders as $order) : ?>
                      <tr>
                        ...
                        <td style="width:12%">
                              <!-- <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#editModal-<?php echo $order['id']; ?>" data-id="<?php echo $order['id']; ?>">Edit</button> -->
                              <a href="<?= site_url('delete_orders_'.$order['id']) ?>" class="btn btn-danger btn-sm delete">Delete</a></h4>    
                            </div>
                          </div>
                        </td>
                      </tr>
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form onsubmit="return confirmSubmit(event)" action="<?= site_url('orders_update_' . $order['id']) ?>" method="POST" enctype="multipart/form-data">
...
<script>
  ...
  // SWEET ALERT FOR SUBMITTING EDIT MODAL
function confirmSubmit(event) {
    event.preventDefault(); 

    Swal.fire({
      title: 'Are you sure?',
      text: "You are about to modify the order",
      icon: 'question',
   ...
   $(document).ready(function() {
        $('button[data-toggle="modal"]').click(function() {
            ...
            var orderId = $(this).data('id'); // Extract category ID from data-id attribute
            $(targetModalId).find('form').attr('action', 'orders_update_' + orderId); // Update form action URL
        });
    });
   ...
   $('.delete').on('click',function (e) {
        ...
        Swal.fire({
            title: 'Are you sure?',
            text: "You are going to delete an order",
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#28a745',
            cancelButtonColor: '#d33',
