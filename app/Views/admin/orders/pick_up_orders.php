                  ...
                  <tbody>
                    <?php foreach($orders as $order) : ?>
                      <tr>
                        ...
                        <td>
                           <form id="deliveredOrders" action="<?= base_url('orders_update_' . $order['id']) ?>" method="post">
                          ...
                          <button type="button" class="btn btn-primary fw-bold acceptButton" data-order-id="<?= $order['id'] ?>">Completed</button>
                         </form>
                            </div>
                          </div>
                        </td>
