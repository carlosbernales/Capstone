                  ...
                  <div class="card-body">
                    ...
                    <?php foreach($payment as $row) : ?>
                      <tr>
                          ...
                          <td><?= $row['payment_date_formatted'] ?></td>
                          <td><?= $row['status'] ?></td>
                           <td>
                          <form id="toPayOrders" action="<?= site_url('confirm_Payment_' . $row['id']) ?>" method="post">
                          <input type="hidden" name="fk_id" value="<?= $row['fk_id'] ?>">
                          <input type="hidden" name="status" value="Completed">
                          <input type="hidden" value="<?= $row['email'] ?>" name="email">
                          <input type="hidden" value="<?= $row['reference_id'] ?>" name="reference_id">
                          <input type="hidden" value="<?= $row['fk_id'] ?>" name="booking_id">
                          <input type="hidden" value="<?= $row['total_payment'] ?>" name="payment_amount">
                          <button class="btn btn-primary fw-bold" type="submit">Verify</button>
                      </form>
                          </td>
                        </tr>
                      <?php endforeach; ?>
