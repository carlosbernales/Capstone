                  ...
                  <tbody>
                    <?php foreach($booking as $row) : ?>
                        <tr>
                          ...
                          <td><?php echo $row['booking_date_formatted']; ?></td>
                         <td><?php 
                                $startDateTime = new DateTime($row['start']);
                                echo $startDateTime->format('h:i A'); 
                            ?></td>
                          ...
                          <td>
                                <?php
                                    if (empty($row['payment_amount']) || $row['payment_amount'] == 0) {
                                        ...
                                        $result = $row['balance'] - $row['payment_amount'];
                                        if ($result == 0) {
                                            echo "Paid";
                                        } else {
                                            echo "₱" . $result;
                          ...
                          <td style="width:12%">
                            ...
                            <a href="<?= site_url('reservation_delete_'.$row['id']) ?>" class="btn btn-danger btn-sm delete">Delete</a></h4>
                          </td>
                        </tr>
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="editModalLabel-<?php echo $row['id']; ?>">Edit Reservation</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                <form action="<?= site_url('reservation_update_'.$row['id']) ?>" method="POST" enctype="multipart/form-data" onsubmit="return confirmSubmit(event)">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group mb-2">
                                                    ...
                                                    <input type="text" class="form-control" id="name" name="fullname" value="<?php echo $row['fullname']; ?>"readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mb-2">
                                                    ...
                                                    <input type="text" class="form-control" id="name" name="contact" value="<?php echo $row['contact']; ?>"readonly>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mb-2">
                                                    ...
                                                    <input type="text" class="form-control" id="name" name="payment_amount" value="<?php echo $row['payment_amount']; ?>"readonly>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group mb-2">
                                                    ...
                                                    <input type="text" class="form-control" id="name" name="location" value="<?php echo $row['location']; ?>" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mb-2">
                                                    ...
                                                    <input type="text" class="form-control" id="name" name="date" value="<?php echo $row['booking_date_formatted']; ?>"readonly>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group mb-2">
                                                    ...
                                                    <input type="time" class="form-control" id="name" name="start" value="<?php echo $row['start']; ?>">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group mb-2">
                                                    <label>Add Computed Balance</label>
                                                    <input type="number" class="form-control" id="balance" name="balance" value="<?php echo $row['balance']; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <hr>
...
function confirmSubmit(event) {
    ...
    Swal.fire({
      title: 'Are you sure?',
      text: "You are about to modify the reservation",
      icon: 'question',
  ...
  // FOR SUBMITTING THE FORM USING MODAL
  $(document).ready(function() {
        $('button[data-toggle="modal"]').click(function() {
            var targetModalId = $(this).data('target'); // Get the target modal ID
            var reservationId = $(this).data('id'); // Extract category ID from data-id attribute
            $(targetModalId).find('form').attr('action', 'reservation_update_' + reservationId); // Update form action URL
        });
    });
  ...
  //SWEET ALERT FOR DELETING THE RESERVATION
  $('.delete').on('click',function (e) {
        ...
        Swal.fire({
            title: 'Are you sure?',
            text: "You are about deleting reservation. This cannot be undone",
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#28a745',  // Green color for the "Yes" button
            cancelButtonColor: '#d33',
