                ...
                <div class="row">
                    <div class="col-12">
                        <div class="section-title">
                            <h2>Contact Us</h2>
                            <p>There are many variations of communications, you can send us your message here by sending an email</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                            ...
                            <div class="single-info-head">
                                ...
                                <div class="single-info">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="mailto:bituinflowershop@gmail.com">btf2020@gmail.com</a></li>
                                    </ul>
                                </div>
                                <!-- End Single Info -->
                            </div>
                        ...
                        <div class="col-lg-8 col-md-12 col-12">
                            <div class="contact-form-head">
                                <div class="form-main">
                                    <form class="form" method="post" action="<?=base_url("contact_us")?>">
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-12">
