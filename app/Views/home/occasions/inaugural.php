        ...
        <div class="container-fluid page-header">
            <div class="container" >
                <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                    <h3 class="display-4  text-white text-uppercase"><strong>Inaugural</strong></h3>
                    <div class="d-inline-flex  text-white">
                        ...
                        <p class="m-0 text-uppercase"><strong>Inaugural Arrangements</strong></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-xl-12 col-md-12 col-12 p-0 m-0">
            <h5 class="mt-5 text-center text-uppercase" style="letter-spacing: 5px; color: #02a618"><strong>Inaugural Arrangements</strong></h5>
            <h1 class="mb-5 text-center font-weight-bold"><strong>Formal Occasions</strong></h1>
        </div>
      </div>
