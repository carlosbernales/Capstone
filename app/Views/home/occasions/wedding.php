        ...
        <div class="container-fluid page-header">
            <div class="container" >
                <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                    <h3 class="display-4  text-white text-uppercase"><strong>Wedding</strong></h3>
                    <div class="d-inline-flex  text-white">
                        ...
                        <p class="m-0 text-uppercase"><strong>Wedding Designs</strong></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-xl-12 col-md-12 col-12 p-0 m-0">
            <h5 class="mt-5 text-center text-uppercase" style="letter-spacing: 5px; color: #02a618"><strong>Wedding Designs</strong></h5>
            <h1 class="mb-5 text-center font-weight-bold"><strong>Passion Beauty and Fair</strong></h1>
        </div>
      </div>
        ...
        <?php foreach($product as $row) : ?>
          <div class="col-xl-3 col-md-6 mb-4">
            <div class="shadow p-3 mb-5 bg-body">
              ...
              <a href="<?= base_url(); ?>/productdetails/<?= $row['id']; ?>"><img src="<?= base_url("public/products/".$row['product_image'])?>" class="img-fluid" style="width: 275px; height: 250px;" alt="products"></a>
              </div>
              <hr>
              <div class="px-4">
                <div class="mt-2 py-2">
