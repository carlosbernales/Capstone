                        ...
                        <ul id="accordionExample">
                            <li>
                                <h6 class="title" data-bs-toggle="collapse" data-bs-target="#collapseThree"
                                    aria-expanded="true" aria-controls="collapseThree">Cart Overview</h6>
                                <section class="checkout-steps-form-content collapse show" id="collapseThree"
                                    ...
                                    <div class="row">
                                        <div class="cart-list-head mt-3">
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-lg-1 col-md-1 col-12">
                                                    <a><img src="<?= base_url("public/public/products/".$cart_data['product_image']) ?>"></a>
                                                </div>
                                                <div class="col-lg-3 col-md-3 col-12">
                                                    <h5 class="product-name"><a><?= $cart_data['product_name']?></a></h5>
                                                    <input type="hidden" value="<?= $cart_data['id']?>">
                                                </div>
                                                <div class="col-lg-3 col-md-2 col-12">
                                                    <p>&#8369 <?= $cart_data['cart_cost']?></p>
                                                </div>
                                                <div class="col-lg-2 col-md-2 col-12">
                                                    <p id="addcount_<?= $cart_data['id']; ?>"><?= $cart_data['CartQty']?>x</p>
                                                </div>
                                                <div class="col-lg-1 col-md-2 col-12">
                                                </div>
                                                <div class="col-lg-2 col-md-2 col-12">
                                                    <p>&#8369 <?= $cart_data['cart_cost'] * $cart_data['CartQty'] ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <?php } ?>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="checkout-payment-option">
                                                ...
                                                <div class="payment-option-wrapper">
                                                    <div class="single-payment-option">
                                                        <input type="radio" name="payment" id="cod_payment" value="COD" checked>
                                                    ...
                                                    <div class="single-payment-option">
                                                        <input  data-bs-toggle="modal" data-bs-target="#onlinePayModal" type="radio" name="payment" id="online_payment" value="Online">
                                                    ...
                                                    <div class="single-payment-option">
                                                        <input type="radio" name="payment" id="pick_up" value="Pick Up">
                                                        <label for="pick_up">
                                                    ...
                                                    <div class="single-payment-option">
                                                        <input data-bs-toggle="modal" data-bs-target="#onlinePayModal" type="radio" name="payment" id="online_pickup" value="Pick Up (Paid)">
                                        ...
                                        <div class="modal fade review-modal" id="onlinePayModal" tabindex="-1" role="dialog" aria-labelledby="onlinePayModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="number" class="form-control" name="proof_payment" required>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="hidden" class="form-control" name="order_price" value = "<?= $totalItemPrice ?>"required>
                                                                    <input type="hidden" class="form-control" name="order_shipp" value = "<?= $shippingFee ?>"required>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                    ...
                                                    <?php if ($subtotal > 0): ?>
                                                        <a href="javascript:void(0)" onclick="proceedtopay()" class="btn">Place Order</a>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="steps-form-btn button">
                                                ...
                                                <?php if ($subtotal > 0): ?>
                                                    <a href="javascript:void(0)" onclick="proceedtopay()" class="btn btn-alt">Place Order</a>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="checkout-sidebar">
                        <div class="checkout-sidebar-coupon">
                            ...
                            <div class="button">
                                ...
                                <button type="button" class="btn btn-alt" data-bs-toggle="modal" data-bs-target="#chooseAddress" >Choose Address</button>
                            </div>
                        </div>
                        ...
                        <div class="checkout-sidebar-price-table mt-30">
                            ...
                            <div class="sub-total-price">
                                <div class="total-price">
                                    ...
                                    <p class="price">&#8369 <?= $totalItemPrice ?></p>
                                </div>
                                <?php
                                    $shippingFee = 0; // Default shipping fee
                                    if (!empty($shipinfo_checkout)) {
                            ...
                            <div class="total-payable">
                                <div class="payable-price">
                                    ...
                                    <p class="price">&#8369 <span id="subtotal"><?= $subtotal + $shippingFee; ?></span></p>
                                </div>
                            </div>
