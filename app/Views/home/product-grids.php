                ...
                <div class="col-lg-4 col-12">
                    <div class="row">
                        <div class="col-lg-12 col-md-6 col-12 md-custom-padding">
                            <!-- Start Small Banner -->
                            <div class="hero-small-banner" style="background-image: url(/public/client_ui/images/hero/slide5.jpeg);">
                                <div class="content">
...
<section class="trending-product section" style="margin-top: 12px;">
  ...
  <h4><strong>No products available in this category.</strong></h4>
</div>
